...
const Index = () => {
  ...
  return <div className="flex flex-col min-h-screen w-full">
      ...
      <main className="flex-1 pb-16 sm:pb-0 w-full">
        <BackgroundEffects blobColors={{
        first: "bg-purple-200",
        second: "bg-indigo-200",
        third: "bg-violet-200"
      }} blobOpacity={0.35} withSpotlight={true} spotlightClassName="from-purple-500/10 via-violet-500/10 to-blue-500/10" baseColor="bg-white/60" pattern="dots" className="py-0" animationSpeed="slow">
          <div className="space-y-0 w-full">
            ...
            <section ref={addSectionRef(1)} id="how-it-works" className="relative w-full">
            ...
            {/* Search Section */}
            <section ref={addSectionRef(2)} id="find-creators" className="relative w-full">
            ...
            <section ref={addSectionRef(3)} className="w-full">
              <Suspense fallback={<SectionLoader />}>
            ...
            {/* Pricing Section */}
            <section ref={addSectionRef(4)} className="w-full">
              <Suspense fallback={<SectionLoader />}>
                <Pricing />
              </Suspense>
            </section>
            ...
            {/* Final CTA Section */}
            <div ref={addSectionRef(5)} className="relative w-full">
              <div className="relative z-10 max-w-7xl mx-auto py-14 sm:py-20 lg:py-24 bg-[brand-text-light] bg-white">
                <CallToActionSection />
              </div>
            </div>
          </div>
