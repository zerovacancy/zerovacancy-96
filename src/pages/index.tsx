...
const Index = () => {
  ...
  return (
    <div className={cn(
      ...
      isMobile && "mobile-view overflow-x-hidden overflow-y-auto"
    )}>
      <Header />
      ...
      <main className={cn(
        ...
        isMobile && "mobile-main overflow-visible"
      )}>
        <BackgroundEffects 
          ...
          className={cn("py-0 overflow-visible", isMobile && "mobile-background overflow-visible")}
          animationSpeed={mobileBackgroundSettings.animationSpeed}
        >
          <div className={cn(
            "space-y-0 w-full", 
            isMobile && "mobile-sections-container overflow-visible"
          )}>
            {/* Hero Section - Always visible */}
            <section ref={addSectionRef(0)} className={cn(
              "w-full", 
              isMobile && "mobile-section mobile-hero overflow-visible"
            )}>
              <Hero />
            </section>
            
            {/* How It Works Section */}
            <section ref={addSectionRef(1)} id="how-it-works" className={cn(
              "relative w-full", 
              isMobile && "mobile-section overflow-visible"
            )}>
              <div className={cn(
                "relative z-10", 
                isMobile && "mobile-content-container overflow-visible"
              )}>
            ...
            {/* Search Section */}
            <section ref={addSectionRef(2)} id="find-creators" className={cn(
              "relative w-full", 
              isMobile && "mobile-section overflow-visible"
            )}>
              <div className={cn(
                "max-w-7xl mx-auto relative z-10 py-10 sm:py-16 lg:py-20", 
                isMobile && "mobile-content-container py-6 overflow-visible"
              )}>
                <Suspense fallback={<SectionLoader />}>
                  <PreviewSearch />
                </Suspense>
            ...
            <section ref={addSectionRef(3)} className={cn(
              "w-full", 
              isMobile && "mobile-section mobile-features overflow-visible"
            )}>
              <Suspense fallback={<SectionLoader />}>
            ...
            {/* Pricing Section */}
            <section ref={addSectionRef(4)} className={cn(
              "w-full", 
              isMobile && "mobile-section mobile-pricing overflow-visible"
            )}>
              <Suspense fallback={<SectionLoader />}>
                <Pricing />
              </Suspense>
            ...
            {/* Final CTA Section */}
            <div ref={addSectionRef(5)} className={cn(
              "relative w-full", 
              isMobile && "mobile-section mobile-cta overflow-visible"
            )}>
              <div className={cn(
                "relative z-10 max-w-7xl mx-auto py-14 sm:py-20 lg:py-24 bg-[brand-text-light] bg-white", 
                isMobile && "py-8 mobile-content-container overflow-visible"
              )}>
                <CallToActionSection />
              </div>
            </div>
