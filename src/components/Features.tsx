  ...
  return (
    <section className="py-6 sm:py-12 rounded-sm relative overflow-hidden bg-white/50 backdrop-blur-sm">
      ...
      <GlowingEffect 
        ...
        glow
      />
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 mb-6 sm:mb-8 relative z-10">
        <div className="mx-auto max-w-2xl text-center">
          <h2 className="text-lg sm:text-xl lg:text-2xl mb-2 sm:mb-3 text-primary font-semibold">
            Professional Content Creation Services
          </h2>
          <p className="text-xs sm:text-sm text-muted-foreground/90 max-w-xl mx-auto">
            Everything you need to showcase your properties with stunning visuals and engaging content
          </p>
        </div>
      </div>
      <div className="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-4 gap-2 sm:gap-3 relative z-10 max-w-7xl mx-auto px-3 sm:px-6 lg:px-8">
  ...
  return (
    ...
    >
      <div className={cn(
        ...
        <h3 className={cn(
          "text-xs font-semibold text-primary/90 transition-all duration-300 flex-1",
          "sm:text-sm",
      ...
      <div className={cn(
        ...
        isExpanded ? "max-h-24 sm:max-h-32" : "max-h-0"
      )}>
        <p className={cn(
          "text-xs leading-relaxed text-muted-foreground/80 relative z-10",
