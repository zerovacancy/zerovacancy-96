...
export const PreviewContent: React.FC<PreviewContentProps> = ({
  ...
  return (
    <div className="flex flex-col w-full relative z-10 overflow-visible">
      {/* SearchBar container */}
      <div className={cn(
        "w-full px-3 sm:px-6 md:px-8 lg:px-10 overflow-visible",
      ...
      {!isMobile && (
        <div className="h-px w-full bg-gradient-to-r from-transparent via-purple-200/50 to-transparent mx-auto max-w-[90%] overflow-visible"></div>
      )}
