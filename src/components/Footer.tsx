      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 md:gap-8 pb-8">
          <div className="space-y-3">
            <h3 className="text-lg font-semibold">CreativeEstate</h3>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <a href="mailto:support@creativeestate.com" className="text-primary-foreground/70 hover:text-primary-foreground text-sm">
                  support@creativeestate.com
                </a>
              </li>
