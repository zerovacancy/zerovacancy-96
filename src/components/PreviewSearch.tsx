        ...
        <BackgroundGradient containerClassName="mx-4 sm:mx-0">
          <Card className="p-4 sm:p-6 mb-6 sm:mb-8 backdrop-blur-sm bg-[#F1F0FB]/95 border-[#E5DEFF] shadow-lg">
            <div className="flex flex-col sm:flex-row items-center justify-between mb-4 sm:mb-6">
              <h2 className="text-2xl font-semibold text-gray-800 mb-2 sm:mb-0">Discover Local Creators</h2>
            ...
            <div className="flex flex-col items-center mt-4 pt-4 border-t relative">
              <button
              ...
              <span className="absolute right-0 top-4 px-2 py-0.5 text-xs font-medium bg-accent text-accent-foreground rounded">
                PRO
              </span>
            </div>
