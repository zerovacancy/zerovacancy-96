...
const PreviewSearch = () => {
  ...
  return (
    <section className="relative bg-secondary/50 section-padding">
      {/* Gradient Overlay */}
      ...
      <div className="relative mx-auto max-w-7xl">
        ...
        <Card className="p-6 mb-8 backdrop-blur-sm bg-background/95 border-0 shadow-lg">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-4">
            <div className="group flex items-center gap-2 p-4 bg-secondary rounded-lg transition-all duration-200 focus-within:bg-background focus-within:shadow-sm">
              ...
              <input
                ...
                className="w-full bg-transparent border-none focus:outline-none placeholder:text-muted-foreground/70"
              />
            </div>
            ...
            <Button 
              className="w-full h-14 text-base hover:scale-[1.02] transition-transform"
            >
              Find Creators
            </Button>
          </div>
          ...
          <div className={`grid grid-cols-1 md:grid-cols-3 gap-6 mt-6 overflow-hidden transition-all duration-200 ${
