...
export const PricingCardFeature = ({
  ...
  const hasSeoOptimized = featureText.includes("SEO-Optimized");
  const hasGeoTargeted = featureText.includes("Geo-Targeted");
  ...
  return (
    ...
    >
      ...
      <div className="flex items-start flex-1">
        ...
        {(hasSeoOptimized || hasGeoTargeted) && (
