...
const CallToActionSection = () => {
  return (
    <div className="relative py-10 sm:py-12 lg:py-14 bg-gradient-to-b from-slate-950 to-slate-900">
      <div className="mx-auto max-w-7xl text-center relative z-10 px-4 sm:px-6 lg:px-8">
        ...
        <p className="text-slate-300 max-w-2xl mx-auto mb-6 sm:mb-8 text-sm sm:text-base lg:text-lg">
