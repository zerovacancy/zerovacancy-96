  ...
  return (
    <section id="pricing" className="py-12 sm:py-20 lg:py-24 relative overflow-hidden bg-white">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold tracking-tight mb-4 bg-gradient-to-r from-violet-600 via-blue-600 to-emerald-600 text-transparent bg-clip-text">
            Simple, transparent pricing
          </h2>
          <p className="text-base sm:text-lg text-slate-600 max-w-2xl mx-auto">
            Choose the perfect plan for your property marketing needs with no hidden fees
          </p>
        </motion.div>
        ...
        <div className="grid grid-cols-1 gap-6 md:gap-8 lg:grid-cols-3 sm:grid-cols-2">
          ...
          <motion.div
            ...
            className="lg:scale-105 lg:-translate-y-2 z-10"
          >
