...
export function Hero() {
  ...
  return (
    <div className="w-full bg-gradient-to-b from-slate-900 to-slate-950">
      <div className="flex gap-4 sm:gap-6 lg:gap-8 items-center justify-center flex-col px-4 sm:px-6 py-4 sm:py-6 lg:py-8 min-h-[calc(100vh-4.5rem)] sm:min-h-0">
        <div className="flex gap-3 sm:gap-4 flex-col max-w-4xl mx-auto w-full">
          <h1 className="text-[2rem] sm:text-5xl md:text-6xl tracking-wide leading-[1.15] sm:leading-normal text-center py-3 sm:py-4 my-4 sm:my-6 font-bold lg:text-7xl text-white">
            <span className="inline whitespace-normal sm:whitespace-nowrap tracking-wide font-light">
          ...
          <p className="text-sm sm:text-base lg:text-lg leading-relaxed tracking-wide text-slate-300 max-w-2xl text-center mx-auto px-2 sm:px-4 [word-spacing:0.12em] sm:[word-spacing:0.16em]">
