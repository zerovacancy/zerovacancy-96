        ...
        >
          {isLoading ? (
            ...
            <>
              ...
              {/* Limited spots badge - small pill */}
              <span className="absolute -top-1 -right-1 text-[8px] bg-white text-purple-700 px-1.5 py-0.5 rounded-full font-bold border border-purple-200 shadow-sm hidden sm:inline-block">
                Limited spots
              </span>
            </>
          )}
