...
// Define proper TypeScript interfaces for the Grad and Noise classes
interface GradInstance {
  x: number
  y: number
  z: number
...
class Grad implements GradInstance {
  x: number
  y: number
  z: number
...
class Noise implements NoiseInstance {
  grad3: GradInstance[]
  p: number[]
  perm: number[]
  gradP: GradInstance[]
...
export function Waves({
  ...
  const noiseRef = useRef<NoiseInstance>(new Noise(Math.random()))
