...
const OptimizedHowItWorks: React.FC = () => {
  ...
  return (
    <BeamsBackground 
      ...
      intensity="subtle"
    >
      <div id="how-it-works" className={`max-w-6xl mx-auto relative px-4 sm:px-6 lg:px-10 transition-all duration-700 ${isVisible ? 'opacity-100' : 'opacity-0 translate-y-10'}`}>
